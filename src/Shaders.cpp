...
void ShaderProgram::loadShaderProgram(std::string vertexShaderName, std::string fragmentShaderName)
{
	Shader vertexShader, fragmentShader, commonShader;

	vertexShader.loadShader("data/shaders/" + vertexShaderName, GL_VERTEX_SHADER);
	fragmentShader.loadShader("data/shaders/" + fragmentShaderName, GL_FRAGMENT_SHADER);
